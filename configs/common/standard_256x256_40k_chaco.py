...
dataset_type = 'CHACO_CD_Dataset'
data_root = 'data/CHACO'
...
test_pipeline = [
    ...
    dict(type='MultiImgResize', scale=(1048, 1048), keep_ratio=True),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path_from='train/T0',
            img_path_to='train/T1'),
...
train_cfg = dict(type='IterBasedTrainLoop', max_iters=8000, val_interval=100)
